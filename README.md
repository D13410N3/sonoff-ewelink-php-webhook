...
У Sonoff-устройств нет публичного API для разработки своих приложений.
Единственный способ полноценно перевести Sonoff на полное управление через свое приложение - перевести их в режим DIY, что вызывает определенные сложности (требуется разборка устройства и танцы с бубном)
