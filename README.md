...
4.1 Создание апплетов (для выкючателей, реле и т.д.)
...
4.2 Создание апплетов (для датчиков, сенсоров и т.д.)
...
5. В скрипте учтена вероятность "задвоения" событий реле. Как она может проявиться:
